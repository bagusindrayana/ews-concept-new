<script lang="ts">
  import type { TitikTsunami } from "./TitikTsunami";

  interface Props {
    alertTsunami: TitikTsunami;
  }

  let { alertTsunami }: Props = $props();
...
<div
  ...
  id="tsunami-warning"
>
  <div class="w-full h-full absolute -rotate-90">
    <div class="main" id="bg-tsunami">
      <div class="hex-bg">
        {#each divs as div}
          <div style={div.style}>
